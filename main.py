...
# 圖片相關
arpei_left_img = pygame.transform.scale(pygame.image.load(os.path.join("img", "arpei.png")).convert(), (150, 180))
arpei_right_img = pygame.transform.flip(arpei_left_img, True, False)
floor_imgs = []
for i in range(2):
    floor_imgs.append(pygame.image.load(os.path.join("img", f"floor{i}.png")).convert())
